...
-- Corrects migration 0040 for the PostgreSQL 9.6 development database, which
-- does not implement the jsonb minus text[] operator. Keep the explicit column
-- allowlist so future identity fields remain Master-only by default.
